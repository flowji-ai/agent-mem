...
1. **Create a custom mode** (`agent-workflow.json`) that:
   ...
   - Updates snapshot prompt to use the 9-field schema (see `05-phase-one-brief.md`)
...
See `05-phase-one-brief.md` for the full detailed brief.
...
- **Semantic signal detection** — provisional design in `05-phase-one-brief.md`, implementation approach to confirm
