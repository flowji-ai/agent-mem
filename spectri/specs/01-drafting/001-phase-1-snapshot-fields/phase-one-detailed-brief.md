...
- `spectri/research/snapshot-quality-analysis.md` — why we're making these changes
...
*Research task pending — see `spectri/research/research-and-discovery.md`. Design below is provisional.*
